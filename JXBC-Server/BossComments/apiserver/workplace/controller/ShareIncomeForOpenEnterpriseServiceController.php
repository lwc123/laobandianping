 ...
 * )
 */ 
class ShareIncomeForOpenEnterpriseServiceController extends PaymentHandlerController {
	/**
	 * @SWG\POST(
	 *     path="/workplace/ShareIncomeForOpenEnterpriseService/Preprocess",
	 *     summary="企业开户前的预处理",
    ...
    /**    
     * @SWG\POST(
     *     path="/workplace/ShareIncomeForOpenEnterpriseService/BizProcess",
     *     summary="企业开户",     
     *     tags={"PaymentBizProcessor"},
     *     @SWG\Parameter(
     *         name="body",
