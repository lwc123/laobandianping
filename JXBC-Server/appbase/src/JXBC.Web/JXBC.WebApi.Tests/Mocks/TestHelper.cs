...
namespace JXBC.WebApi.Tests.Mocks
{
    public static class TestHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetTestImageStream()
        {
            FileStream fs = File.OpenRead(ConfigurationManager.AppSettings["TestImage"]);
            int filelength = 0;
        ...
        static object GetRndValue(string propName, Type propType)
        {
            if (propType.IsEnum)
            {
