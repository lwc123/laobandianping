...
public class EaseVoiceRecorder {
    ...
    public EaseVoiceRecorder(Context context,Handler handler) {
    ...
    public String startRecording(Context appContext) {
        ...
        try {
            ...
            recorder.setAudioEncodingBitRate(64); // seems if change this to
                                                    ...
                                                    // size.
            // shortvideo easy way is to use temp file
            // file = File.createTempFile(PREFIX + userId, EXTENSION,
            // User.getVoicePath());
            voiceFileName = getVoiceFileName(AppContext.getCurrent().getUserAuthentication().getCurrentAccount().getProfile().MobilePhone+"");
//            voiceFilePath = PathUtil.getInstance().getVoicePath() + "/" + voiceFileName;
            File filePath = ImageUtils.getFileCacheDirectory(context,"com.juxian.bosscomments/OutVoice");
            voiceFilePath = filePath + "/" + voiceFileName;
            ...
            Log.e(Global.LOG_TAG, "prepare() failed");
        }
...
//                    }
//                } catch (Exception e) {
//                    // from the crash report website, found shortvideo NPE crash from
//                    // shortvideo android 4.0.4 htc phone
...
//        }).start();
        ...
        Log.e(Global.LOG_TAG, "start voice recording to file:" + file.getAbsolutePath());
    ...
    public int stopRecoding() {
        if(recorder != null){
            ...
            Log.e(Global.LOG_TAG, "voice recording finished. seconds:" + seconds + " file length:" + file.length());
            return seconds;
        }
        return 0;
    }
