 ...
 * 双层进度圆弧，底下一层是满圆，且底下一层的满圆的线条宽度要与上面一层相比要小于等于，而不能大于、
 *
 *
 * @author xiaanming
 */
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        textColor = mTypedArray.getColor(R.styleable.RoundProgressBar_centerTextColor, Color.GREEN);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int radius = (int) (centre - roundProgressWidth / 2); //圆环的半径
