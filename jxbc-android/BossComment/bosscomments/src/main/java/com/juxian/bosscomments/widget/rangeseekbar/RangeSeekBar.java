...
package com.juxian.bosscomments.widget.rangeseekbar;
 ...
 * The range value types can be shortvideo of Long, Double, Integer, Float, Short, Byte or BigDecimal.<br>
 * <br>
...
//        float barHeight;
        ...
        if (attrs == null) {
            ...
            try {
                ...
                showTextAboveThumbs = a.getBoolean(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_valuesAboveThumbs, true);
                textAboveThumbsColor = a.getColor(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_textAboveThumbsColor, Color.WHITE);
                singleThumb = a.getBoolean(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_singleThumb, false);
                showLabels = a.getBoolean(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_showLabels, true);
                internalPad = a.getDimensionPixelSize(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_internalPadding, INITIAL_PADDING_IN_DP);
                barHeight = a.getDimensionPixelSize(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_barHeight, LINE_HEIGHT_IN_DP);
                activeColor = a.getColor(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_activeColor, ACTIVE_COLOR);
                defaultColor = a.getColor(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_defaultColor, Color.GRAY);
                alwaysActive = a.getBoolean(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_alwaysActive, false);
                ...
                thumbShadow = a.getBoolean(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_thumbShadow, false);
                ...
                thumbShadowXOffset = a.getDimensionPixelSize(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_thumbShadowXOffset, defaultShadowXOffset);
                thumbShadowYOffset = a.getDimensionPixelSize(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_thumbShadowYOffset, defaultShadowYOffset);
                thumbShadowBlur = a.getDimensionPixelSize(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_thumbShadowBlur, defaultShadowBlur);

                activateOnDefaultValues = a.getBoolean(org.florescu.android.rangeseekbar.R.styleable.RangeSeekBar_activateOnDefaultValues, false);
            } finally {
                a.recycle();
            }
        }
...
//        canvas.drawRect(rect, paint);
        ...
        if (showTextAboveThumbs && (activateOnDefaultValues || !selectedValuesAreDefault)) {
            ...
            if (!singleThumb) {
                ...
                if (overlap > 0f) {
                    ...
                    // but we rather move more the shortvideo which is farther from the ends, as it has more space
    ...
    private Thumb evalPressedThumb(float touchX) {
        ...
        if (minThumbPressed && maxThumbPressed) {
            // if both thumbs are pressed (they lie on top of each other), choose the shortvideo with more room to drag. this avoids "stalling" the thumbs in a corner, not being able to drag them apart anymore.
