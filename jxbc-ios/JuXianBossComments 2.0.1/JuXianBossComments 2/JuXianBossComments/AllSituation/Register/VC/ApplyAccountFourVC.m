...
- (void)initUI{
    ...
    UILabel * showLabel = [UILabel labelWithFrame:CGRectMake((SCREEN_WIDTH - 200) * 0.5, CGRectGetMaxY(imageView.frame) + 20, 200, 50) title:@"您的开户申请已经成功提交，24小时内会短信通知您审核的结果\n如有问题请联系：400-815-9166" titleColor:[PublicUseMethod setColor:KColor_Text_ListColor] fontSize:12.0 numberOfLines:2];
    showLabel.textAlignment = NSTextAlignmentCenter;
    [self.view addSubview:showLabel];
    
    // 联系我们按钮
    [self.view addSubview:self.contactUsButton];
    self.contactUsButton.y = CGRectGetMaxY(showLabel.frame)+5;
