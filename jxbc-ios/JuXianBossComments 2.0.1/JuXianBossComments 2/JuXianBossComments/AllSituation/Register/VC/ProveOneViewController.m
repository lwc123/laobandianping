...
- (void)initUI{
    ...
    _bgLabel= [[UILabel alloc] initWithFrame:CGRectMake(45, CGRectGetMaxY(headerView.frame) + 5, SCREEN_WIDTH - 90, 17)];
    ...
    self.oneView.y = CGRectGetMaxY(_bgLabel.frame) +30;
