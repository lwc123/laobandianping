...
//    _account.UserProfile.CurrentProfileType = 2;
    
    NSString * organization = [NSString stringWithFormat:@"%d",2];
    [[NSUserDefaults standardUserDefaults] setObject:organization forKey:@"organizationId"];
    [[NSUserDefaults standardUserDefaults]synchronize];
    
//    [UserAuthentication SaveCurrentAccount:_account];
    
    NSLog(@"_account.UserProfile.CurrentProfileType===%d",_account.UserProfile.CurrentProfileType);
