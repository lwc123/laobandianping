...
- (void)initUI{
    ...
    _placehoderArray = @[@"请填写开户信息",@"请输入和营业执照一致的公司名称",@"请输入您的姓名",@"请输入您的身份或担任的职务"];
    
    
    
    
    self.jxTableView.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - 64);
    _iconImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 185)];
    ...
    //支付/Users/juxian/Desktop/ios商务@2x.png
