...
//    UMSocialPlatformType_WechatTimeLine,//微信朋友圈
    ...
    //创建网页内容对象
    UMShareWebpageObject *shareObject = [UMShareWebpageObject shareObjectWithTitle:self.sManager.shareModel.Brief descr:self.sManager.shareModel.Content thumImage:LOGO_Image];
