...
//------
@property (nonatomic,strong)UIColor *tagLastStrokeColor;
@property (nonatomic,strong)UIColor *tagLastTextColor;
@property (nonatomic,strong)UIFont  *taglastFont;
...
@property (nonatomic,assign)float tagstrokeWith;
