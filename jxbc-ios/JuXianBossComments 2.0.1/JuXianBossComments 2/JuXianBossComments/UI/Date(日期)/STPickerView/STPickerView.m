...
//    _titleColor = titleColor;
    [self.labelTitle setTextColor:[PublicUseMethod setColor:KColor_Text_WhiterColor]];
    
    [self.buttonLeft setTitleColor:[PublicUseMethod setColor:KColor_Text_WhiterColor] forState:UIControlStateNormal];
    [self.buttonRight setTitleColor:[PublicUseMethod setColor:KColor_GoldColor] forState:UIControlStateNormal];
}
...
- (UIView *)contentView
{
    if (!_contentView) {
        ...
        [_contentView setBackgroundColor:[PublicUseMethod setColor:@"666666"]];
    }
    return _contentView;
}
...
- (UIButton *)buttonLeft
{
    if (!_buttonLeft) {
        ...
        [_buttonLeft setTitleColor:[PublicUseMethod setColor:KColor_Text_WhiterColor]  forState:UIControlStateNormal];
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
        ...
        [_buttonRight setTitleColor:[PublicUseMethod setColor:KColor_GoldColor] forState:UIControlStateNormal];
