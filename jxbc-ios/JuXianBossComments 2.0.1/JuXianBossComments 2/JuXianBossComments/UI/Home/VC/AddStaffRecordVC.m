    ...
    if (indexPath.section == 0) {
        if (indexPath.row == 0) {//头像
            ...
            if (!cell) {
                ...
                UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-32-20, 6, 32, 32)];
                imageView.backgroundColor = [PublicUseMethod setColor:KColor_BackgroundColor];
            ...
            if (self.employeEntity) {
                [self.iconImageView sd_setImageWithURL:[NSURL URLWithString:_employeEntity.Picture] placeholderImage:Default_Image];
            }
            
            cell.textLabel.text = @"员工照片";
            ...
            if (indexPath.row == 2) {//姓名
                ...
                _allFieldTex.placeholder = @"请输入身份证号，性别、年龄自动提取";
