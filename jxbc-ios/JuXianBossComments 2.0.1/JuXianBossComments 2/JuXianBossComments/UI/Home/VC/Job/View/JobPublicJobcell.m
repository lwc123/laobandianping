...
//    jobEntity.CompanyMember.RealName
    ...
    self.salaryLabel.text = [NSString stringWithFormat:@"%.2fk-%.2fk",jobEntity.SalaryRangeMin.intValue/1000.0,jobEntity.SalaryRangeMax.intValue/1000.0];
    
    self.statusLabel.hidden = !jobEntity.DisplayState;;
    
    NSString *timeStr;
    
    if ([jobEntity.CreatedTime isEqualToDate:jobEntity.ModifiedTime]) {
