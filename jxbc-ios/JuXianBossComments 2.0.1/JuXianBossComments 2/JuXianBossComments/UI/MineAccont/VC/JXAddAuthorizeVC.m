...
- (void)initUI{
    ...
    // 提示文字
    UILabel * alertLabel = [UILabel labelWithFrame:CGRectMake(20, CGRectGetMaxY(self.jxTableView.frame) + 0, SCREEN_WIDTH - 40, 30) title:@"确认授权后，该用户可以登录老板点评，进行点评，请谨慎操作。" titleColor:[PublicUseMethod setColor:KColor_Text_EumeColor] fontSize:10.0 numberOfLines:0];
