...
@interface JXSaveIdVC ()<JXFooterViewDelegate,UITextFieldDelegate>

@property (nonatomic,strong)UITextField *allFieldText;

@end

@implementation JXSaveIdVC
...
- (void)jxFooterViewDidClickedNextBtn:(JXFooterView *)jxFooterView{
    ...
    MyArchiveList * myArchiveList = self.navigationController.viewControllers[2];
