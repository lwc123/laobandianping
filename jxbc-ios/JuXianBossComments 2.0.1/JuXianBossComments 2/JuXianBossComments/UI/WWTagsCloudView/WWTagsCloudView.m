...
//SC.XJH.10.31
#define PADDING_X 10//词间距
#define MARGIN_LEFT 12//左间距
#define MARGIN_TOP 20//上间距
#define LINE_HEIGHT 35//行距
    ...
    while (indexArray.count > 0) {
        for (int i = 0; i < _lineNum; i++) {
            ...
            while (indexArray.count > 0) {
                ...
                //设定frame
                label.frame = CGRectMake(currentX, MARGIN_TOP + i * LINE_HEIGHT, [self getLabelWidthWithLabel:label] + 20, label.font.lineHeight + 12);
