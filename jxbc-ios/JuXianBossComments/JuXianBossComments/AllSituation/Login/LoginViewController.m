...
- (void)setUpSubViews
{
    ...
    self.login_Btn.layer.borderWidth = 2;
    self.login_Btn.layer.borderColor = [PublicUseMethod setColor:KColor_GoldColor].CGColor;
//    [self.textField_Phone becomeFirstResponder];
    ...
    self.textField_Phone.textColor = [PublicUseMethod setColor:KColor_Text_WhiterColor];
    ...
    self.textField_Pwd.textColor = [PublicUseMethod setColor:KColor_Text_WhiterColor];
