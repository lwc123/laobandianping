...
- (void)initUI{
    ...
    _codeBtn.layer.borderWidth = 2;
    _codeBtn.layer.borderColor = [PublicUseMethod setColor:KColor_GoldColor].CGColor;
    ...
    self.passwordTf.textColor = [PublicUseMethod setColor:KColor_Text_WhiterColor];
    self.passwordTf.tintColor = [PublicUseMethod setColor:KColor_Text_EumeColor];
    [self.passwordTf setValue:[PublicUseMethod setColor:KColor_Text_ListColor] forKeyPath:@"_placeholderLabel.textColor"];
...
- (IBAction)compayProtocolClick:(id)sender {
    ...
    bossComments.title = @"《个人用户协议&隐私政策》";
...
- (IBAction)registerbtnClick:(id)sender {
    ...
    else
    {
        ...
        if (self.protocolBtn.selected == NO) {
            [PublicUseMethod showAlertView:@"请阅读个人用户协议&隐私政策"];
            return;
        }
