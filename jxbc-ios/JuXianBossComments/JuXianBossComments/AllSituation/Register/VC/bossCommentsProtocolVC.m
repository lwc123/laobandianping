...
- (void)initUI{
    ...
    if ([self.secondVC isKindOfClass:[NewRegistreVC class]]) {
        ...
        urlString = [NSString stringWithFormat:@"%@/BossComments/CompanyAgreementAndPrivacy",API_HOST_MOBILE];
    }else{
        urlString = [NSString stringWithFormat:@"%@/BossComments/UserAgreementAndPrivacy",API_HOST_MOBILE];
    }
