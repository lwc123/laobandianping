...
- (void)initUI{
    ...
    _registerBtn.layer.borderColor = [PublicUseMethod setColor:KColor_GoldColor].CGColor;
    _sendBtn.layer.cornerRadius = 4;
    _sendBtn.layer.masksToBounds = YES;
    _sendBtn.layer.borderWidth = 2;
    _sendBtn.layer.borderColor = [PublicUseMethod setColor:KColor_GoldColor].CGColor;
    
    
    self.oneView.backgroundColor = [[PublicUseMethod setColor:KColor_FeildBack_Color] colorWithAlphaComponent:0.2];
    self.twoView.backgroundColor = [[PublicUseMethod setColor:KColor_FeildBack_Color] colorWithAlphaComponent:0.2];
    self.threeView.backgroundColor = [[PublicUseMethod setColor:KColor_FeildBack_Color] colorWithAlphaComponent:0.2];
    ...
    self.phoneNumTF.textColor = [PublicUseMethod setColor:KColor_Text_WhiterColor];
    self.phoneNumTF.tintColor = [PublicUseMethod setColor:KColor_Text_EumeColor];
    [self.phoneNumTF setValue:[PublicUseMethod setColor:KColor_Text_ListColor] forKeyPath:@"_placeholderLabel.textColor"];
    
    self.codeTF.textColor = [PublicUseMethod setColor:KColor_Text_WhiterColor];
    self.codeTF.tintColor = [PublicUseMethod setColor:KColor_Text_EumeColor];
    [self.codeTF setValue:[PublicUseMethod setColor:KColor_Text_ListColor]
               forKeyPath:@"_placeholderLabel.textColor"];
    
    self.passwardTF.textColor = [PublicUseMethod setColor:KColor_Text_WhiterColor];
    self.passwardTF.tintColor = [PublicUseMethod setColor:KColor_Text_EumeColor];
    [self.passwardTF setValue:[PublicUseMethod setColor:KColor_Text_ListColor] forKeyPath:@"_placeholderLabel.textColor"];
...
- (IBAction)bossCommentsProtocol:(id)sender {
    ...
    bossComments.title = @"《企业用户协议&隐私政策》";
...
- (IBAction)registerbtnClick:(id)sender {
    ...
    else
    {
        ...
        if (self.proyocolImageBtn.selected == NO) {
            [PublicUseMethod showAlertView:@"请阅读并同意企业用户协议&私隐政策"];
            return;
        }
