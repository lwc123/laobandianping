...
class JXApiEnvironment : NSObject {
    ...
    //点评详情
    static let Page_OpinionDetail_Endpoint = API_HOST_API_Apppage + "/opinion/opinionDetail?OpinionId=%ld";
    //添加点评opinion/create?CompanyId=1
    static let Page_CreateOpinion_Endpoint = API_HOST_API_Apppage + "/opinion/create?CompanyId=%ld";
