...
- (void)setup
{
    self.itemSize = CGSizeMake(100.0f, 25.0f);
    self.scrollDirection = UICollectionViewScrollDirectionHorizontal;
    self.minimumInteritemSpacing = 9.0f;
    self.minimumLineSpacing = 9.0f;
    if ([UIScreen mainScreen].bounds.size.width==320.0) {
        self.sectionInset = UIEdgeInsetsMake(15.0f, 10.0f, 10.0f, 10.0f);
    }else
    {
    self.sectionInset = UIEdgeInsetsMake(6.0f, 10.0f, 10.0f, 10.0f);
    }
