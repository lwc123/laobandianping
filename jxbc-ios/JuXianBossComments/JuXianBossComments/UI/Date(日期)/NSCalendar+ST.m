...
+ (NSInteger)getFirstWeekdayWithYear:(NSInteger)year
                               month:(NSInteger)month
{
    NSString *stringDate = [NSString stringWithFormat:@"%ld年-%ld月-01日", (long)year, (long)month];
    NSDateFormatter *formatter = [[NSDateFormatter alloc]init];
    [formatter setDateFormat:@"yy年-MM月-dd日"];
                                       ...
                                       componentsTwo:(NSDateComponents *)componentsTwo
{
    ...
    NSString *stringOne = [NSString stringWithFormat:@"%zd年-%zd月-%zd日", componentsOne.year,
                           componentsOne.month,
                           componentsOne.day];
    NSString *stringTwo = [NSString stringWithFormat:@"%zd年-%zd月-%zd日", componentsTwo.year,
                           componentsTwo.month,
                           componentsTwo.day];
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc]init];
    [dateFormatter setDateFormat:@"yy年-MM月-dd日"];
