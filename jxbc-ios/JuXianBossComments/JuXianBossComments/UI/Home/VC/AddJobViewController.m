...
@interface AddJobViewController ()<UITextFieldDelegate,JXFooterViewDelegate,STPickerDateDelegate>
...
- (void)jxFooterViewDidClickedNextBtn:(JXFooterView *)jxFooterView{
    ...
    if (_doorTf.text.length == 0) {
        ...
        if (self.workItemBlock) {
            ...
            //_startDateStr  _overDateStr  只为显示日期
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (!cell) {
        ...
        _allFieldTex = [[UITextField alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-allFieldTexW-10 - 20, 0, allFieldTexW, 44)];
    ...
    _allFieldTex.placeholder = self.placehoderArray[indexPath.row];
