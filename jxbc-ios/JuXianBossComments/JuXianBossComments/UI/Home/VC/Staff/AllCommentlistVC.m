...
- (void)initRecodeDetailWith:(ArchiveCommentEntity *)commentModel{
    ...
    MJWeakSelf
    [WorkbenchRequest getCommentDetailWithCompanyId:_bossMembe.CompanyId CommentId:commentModel.CommentId success:^(ArchiveCommentEntity *commentEntity) {
        ...
        commentsVC.detailComment = commentEntity;
...
- (void)initRecodeWith:(ArchiveCommentEntity *)commentModel{
    ...
    [WorkbenchRequest getCommentDetailWithCompanyId:_bossMembe.CompanyId CommentId:commentModel.CommentId success:^(ArchiveCommentEntity *commentEntity) {
        ...
        if (commentEntity) {
            ...
            commentModel.EmployeArchive = _employeEntity;
            reportVC.detaiComment = commentEntity;
