...
@property (nonatomic, strong) OpinionBottomView * bottomView ;
...
- (void)setUp{
  ...
  //星星
    ...
    _bottomView = [[OpinionBottomView alloc] init];
...
- (void)setOpinionModel:(OpinionEntity *)opinionModel{
    ...
    [_logoImageView sd_setImageWithURL:[NSURL URLWithString:opinionModel.Company.CompanyLogo] placeholderImage:Company_LOGO_Image];
    ...
    self.bottomView.frame = CGRectMake(0, CGRectGetMaxY(self.twoLineView.frame), SCREEN_WIDTH, bottowVIewHeight);
    self.bottomView.opinionModel = opinionModel;
    ...
    */
    ...
    self.cellHeight = bgViewHeight + self.tagCellHeight + 18 + 6 + 10 + [CompanyReputationListCell getTitleTextHeightWithText:self.opinionModel.Title] + 10 + self.contentHeight + bottowVIewHeight + 2;
}
