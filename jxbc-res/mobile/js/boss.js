...
$(function(){
	if($('.change-history').length>0){
		var CommentId=$('.change-history').attr('data-comment-id')
	    $('.change-history').click(function(){
	        AppBridge.gotoNativePage("CommentChangedHistory",CommentId);
	    })
	}
